        ...
        <div className="container">
          <FadeUp>
            ...
            <p className="text-white/60 mt-4 max-w-xl text-base leading-relaxed">
              We deliver clean, inspected containers directly to your site. Below are the areas we currently serve — contact us if you don't see your location listed.
            </p>
          </FadeUp>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-7 flex flex-col gap-5">
              {PLACEHOLDER_AREAS.map((area, i) => (
                <FadeUp key={area.region} delay={(i % 3) as 0 | 1 | 2 | 3 | 4 | 5}>
                ...
                <div className="flex gap-5 p-6 bg-[#1C1C1E] text-white">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/60 leading-relaxed mb-4">
                      We may still be able to deliver to your location. Give us a call or send a message and we'll let you know.
                    </p>
                ...
                <div className="sticky top-24 flex flex-col gap-6">
                  <div className="p-6 bg-[var(--surface)] border border-[var(--border)]">
                    ...
                    <ul className="flex flex-col gap-3">
                      {[
                        { label: "Standard Lead Time", value: "48 hours" },
                        { label: "Same-Day Delivery", value: "Available in [City] — call to confirm" },
                        { label: "Delivery Hours", value: "Mon–Fri, 7am–5pm" },
                        { label: "Weekend Delivery", value: "By arrangement" },
                        { label: "Placement", value: "Driver will position on flat, accessible surface" },
                      ].map((item) => (
                        <li key={item.label} className="flex flex-col gap-0.5 pb-3 border-b border-[var(--border)] last:border-0 last:pb-0">
                  ...
                  <div className="p-6 border-l-2 border-[#D97706] bg-[var(--surface)]">
                    <p className="text-sm font-bold mb-1" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "1rem" }}>
                      Need a container fast?
                    </p>
                    <p className="text-xs text-muted-foreground mb-4">
                      Call us directly for same-day availability and pricing.
                    </p>
                    <a
                      href={SITE.phoneHref}
